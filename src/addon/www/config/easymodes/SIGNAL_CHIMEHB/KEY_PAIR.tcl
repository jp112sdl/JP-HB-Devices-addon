...
set PROFILE_1(SHORT_ACT_TYPE)		{0 range 0 - 255}
...
set PROFILE_1(LONG_ACT_TYPE)		{0 range 0 - 255}
set PROFILE_1(LONG_ACT_NUM)			1
set PROFILE_1(UI_DESCRIPTION)	"Falls der Gong unerw&uuml;nscht ert&ouml;nt, kann er mit dieser Taste ausgeschaltet werden."
...
set PROFILE_2(SHORT_ACT_TYPE)		{0 range 0 - 255}
set PROFILE_2(SHORT_ACT_NUM)		1
set PROFILE_2(SHORT_ACT_INTENS)		{0 range 0 - 10}
...
set PROFILE_2(LONG_ACT_TYPE)		{0 range 0 - 255}
set PROFILE_2(LONG_ACT_NUM)			1
set PROFILE_2(LONG_ACT_INTENS)		{0 range 0 - 10}
...
set PROFILE_3(UI_DESCRIPTION)		"Die Taste ist deaktiviert!"
