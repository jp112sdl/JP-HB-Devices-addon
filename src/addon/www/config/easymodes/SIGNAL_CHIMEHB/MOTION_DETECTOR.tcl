...
# set PROFILE_1(SHORT_ON_TIME)		{111600 300 5}
...
set PROFILE_1(UI_DESCRIPTION)	"Beim Ausl&ouml;sen des Bewegungsmelders ert&ouml;nt der Gong. Ist eine Einschaltverz&ouml;gerungszeit eingestellt, so geschieht es erst nach Ablauf dieser Zeit."
...
#	set ps(SHORT_ON_TIME) 111600 
#	set ps(SHORT_ON_TIME_MODE) 0 
#	set ps(SHORT_OFFDELAY_TIME) 0
