...
**❌ Achtung: Noch kein Support für CCU Version X.53.2x! Ein Release wird erst mit der entsprechenden RaspberryMatic Version erfolgen.** Wird das Addon dennoch installiert, so entsteht ein inkonsistenter Stand der WebUI Files _(nicht alle Patchfiles funktionieren weiterhin)_! <br/>
