...
set PROFILE_1(UI_DESCRIPTION)	"Bei Feuchte wird der Gong entsprechend der gew&auml;hlten Schaltrichtung geschaltet."
...
set PROFILE_2(UI_DESCRIPTION)		"Der Wassermelder ist deaktiviert."
