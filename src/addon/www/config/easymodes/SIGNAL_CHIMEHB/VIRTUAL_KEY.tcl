...
set PROFILE_1(LONG_ACT_INTENS) 0	
set PROFILE_1(UI_DESCRIPTION)	"Mit einem kurzen oder langen Tastendruck ert&ouml;nt der Gong. Ist eine Einschaltverz&ouml;gerungszeit eingestellt, so geschieht es erst nach Ablauf dieser Zeit."
