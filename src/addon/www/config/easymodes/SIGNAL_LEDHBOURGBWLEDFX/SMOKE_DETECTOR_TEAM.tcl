...
set PROFILE_1(UI_DESCRIPTION)	"Bei Ausl&ouml;sen des Rauchmelders wird die Signalleuchte des Gongs geschaltet."
...
set PROFILE_2(UI_DESCRIPTION)		"Der Rauchmelder ist deaktiviert."
