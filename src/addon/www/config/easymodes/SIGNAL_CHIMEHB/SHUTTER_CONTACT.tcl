...
set PROFILE_1(SHORT_ACT_TYPE)		{0 16}
set PROFILE_1(SHORT_ACT_NUM)		1
set PROFILE_1(SHORT_ACT_INTENS)		0
set PROFILE_1(LONG_ACTION_TYPE)		0
set PROFILE_1(UI_DESCRIPTION)	"Bei Bet&auml;tigung des Kontaktes wird der Gong entsprechend der gew&auml;hlten Schaltrichtung geschaltet."
set PROFILE_1(UI_TEMPLATE)		$PROFILE_1(UI_DESCRIPTION)	
set PROFILE_1(UI_HINT)	1

set PROFILE_2(SHORT_ACT_TYPE)		0
set PROFILE_2(SHORT_ACT_NUM)		0
set PROFILE_2(SHORT_ACT_INTENS)		0
set PROFILE_2(LONG_ACT_TYPE)		0
set PROFILE_2(LONG_ACT_NUM)			0
set PROFILE_2(LONG_ACT_INTENS)			0
