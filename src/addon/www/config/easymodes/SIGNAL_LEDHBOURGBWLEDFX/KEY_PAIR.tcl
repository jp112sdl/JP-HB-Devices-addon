...
set PROFILE_1(LONG_ACT_NUM)			6
set PROFILE_1(UI_DESCRIPTION) "Falls die Signalleuchte unerw&uuml;nscht blinkt, kann sie mit dieser Taste ausgeschaltet werden."
...
set PROFILE_2(SHORT_ACT_NUM)		{6 7}
...
set PROFILE_2(LONG_ACT_NUM)			{6 7}
set PROFILE_2(UI_DESCRIPTION) "Mit einem kurzen oder langen Tastendruck wird die Signalleuchte des Gongs entsprechend des gew&auml;hlten Schaltmodus geschaltet."
set PROFILE_2(UI_TEMPLATE)		$PROFILE_2(UI_DESCRIPTION)	
set PROFILE_2(UI_HINT)	2

set PROFILE_3(SHORT_ACTION_TYPE)	0
set PROFILE_3(LONG_ACTION_TYPE)	0
set PROFILE_3(UI_DESCRIPTION)		"Das Ger&auml;t ist nicht aktiv!"
...
#	die Texte der Platzhalter einlesen
	puts "<script type=\"text/javascript\">getLangInfo('$dev_descr_sender(TYPE)', '$dev_descr_receiver(TYPE)HBOURGBWLEDFX');</script>"
	set prn 0	
...
# Signalart	
	source [file join $env(DOCUMENT_ROOT) config/easymodes/SIGNAL_LEDHBOURGBWLEDFX/signal_type.tcl]
	append HTML_PARAMS(separate_$prn) "</table></textarea></div>"
