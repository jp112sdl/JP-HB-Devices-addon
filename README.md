...
**✅ lauffähig unter CCU / RaspberryMatic Firmware 3.47.10 - 3.61.5 [inkl. x86]**<br/>
**❓ CCU2 Firmware 2.53.27 - 2.59.7 nur experimentell unterstützt (nicht real getestet; nur gegen ubi-Image)**<br/>
Die für o.g. CCU-Firmware-Versionen jeweils aktuellste Addon-Version ist bei den [Releases](https://github.com/jp112sdl/JP-HB-Devices-addon/releases/latest) zu finden.<br/>
