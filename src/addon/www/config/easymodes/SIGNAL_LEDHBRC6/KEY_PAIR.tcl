...
#	die Texte der Platzhalter einlesen
	puts "<script type=\"text/javascript\">getLangInfo('$dev_descr_sender(TYPE)', '$dev_descr_receiver(TYPE)HBRC6');</script>"
	set prn 0	
...
# Signalart	
	source [file join $env(DOCUMENT_ROOT) config/easymodes/SIGNAL_LEDHBRC6/signal_type.tcl]
	append HTML_PARAMS(separate_$prn) "</table></textarea></div>"
