...
set PROFILE_1(LONG_ACT_NUM)			{6 7}
set PROFILE_1(UI_DESCRIPTION) "Mit einem kurzen oder langen Tastendruck wird die Signalleuchte des Gongs entsprechend des gew&auml;hten Schaltmodus geschaltet."
...
set PROFILE_2(UI_DESCRIPTION)		"Die Taste ist deaktiviert."
set PROFILE_2(UI_TEMPLATE)		$PROFILE_2(UI_DESCRIPTION)	
set PROFILE_2(UI_HINT) 2


#set SUBSET_1(NAME)					"Ein"
...
set SUBSET_1(SHORT_JT_ONDELAY)		0 

#set SUBSET_2(NAME)					"Ein / Aus"
set SUBSET_2(NAME)					"\${subset_2}"
set SUBSET_2(SUBSET_OPTION_VALUE)	2
set SUBSET_2(SHORT_JT_OFF)			1
set SUBSET_2(SHORT_JT_ON)			3
set SUBSET_2(SHORT_JT_OFFDELAY)		4
set SUBSET_2(SHORT_JT_ONDELAY)		2 
