...
set PROFILES_MAP(3) "\${signal_led_chime_non_active}"
...
set PROFILE_7(UI_MAP) 1
set PROFILE_8(UI_MAP) 2
...
set PROFILE_3(SHORT_ACT_TYPE)		0
set PROFILE_3(SHORT_ACT_NUM)		0
set PROFILE_3(LONG_ACT_TYPE)		0
set PROFILE_3(LONG_ACT_NUM)			0
set PROFILE_3(UI_DESCRIPTION)		"Die virtuelle Taste ist deaktiviert."
