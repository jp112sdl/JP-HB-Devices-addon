...
set PROFILE_1(UI_DESCRIPTION)	"Bei Bet&auml;tigung des Kontaktes wird die Signalleuchte des Gongs entsprechend der gew&auml;hlten Schaltrichtung geschaltet."
...
set PROFILE_2(UI_DESCRIPTION)		"Der Kontakt ist deaktiviert."
