...
set PROFILE_1(UI_DESCRIPTION)	"Bei Bet&auml;tigung des Schaltkontaktes wird die Signalleuchte des Gongs entsprechend des gew&auml;hlten Schaltmodus geschaltet."
